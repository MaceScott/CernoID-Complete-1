...
def measure_performance(metric_name: Optional[str] = None) -> Callable:
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            metrics_collector.start_tracking(metric)
            
            try:
                result = await func(*args, **kwargs)
                execution_time = metrics_collector.stop_tracking(metric)
    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                # Record metric
                metric = metric_name or func.__name__
                metrics_collector.record_time(f"{metric}_memory", memory_used)
