...
export function CameraFeed({ 
  ...
  const { messages, isConnected } = useWebSocket(`ws://localhost:8000/ws/camera/${id}`)
  ...
  useEffect(() => {
    ...
    const setupVideo = async () => {
      try {
        ...
        // TODO: Replace with actual camera stream
  ...
  useEffect(() => {
    ...
    if (lastMessage?.type === 'recognition') {
      setRecognitions(lastMessage.data)
    }
  }, [messages])
